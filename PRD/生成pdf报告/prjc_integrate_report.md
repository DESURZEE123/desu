...
| 5 | 刚性负债分析 | 刚性负债分析 · 功能整合 | `prjc_integrate_liability_analysis` | `liability_analysis` | 详见该资源文档；`prjc-flr` / `prjc-si` 整模块不输出 |
| 6 | 重点指标 | 重点指标 · 功能整合 | `prjc_integrate_key_indicators` | `key_indicators` | 详见该资源文档；`prjc-flr` / `prjc-si` 整模块不输出 |
| — | 其他模块 | — | — | — | 后续扩展 |
